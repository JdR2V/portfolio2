...
function AboutMe(){
    ...
    return (
        <div className="mx-auto max-w-screem-lg text-center">
            ...
            <p className="pb-14 lg:text-2xl text-lg">With more than 5 years of experience as a developer, I've had the privilege of working with amazing teams and as a solo developer in many incredible projects with incredible results.</p>
